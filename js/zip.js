...
(function (exports) {
    ...
    var ZipClass = (function () {
        ...
        ZipClass.prototype.giveMeSomeSugar = function () {
            return "Hello, " + this.greeting;
        };

        ZipClass.prototype.Archive = function (archive)
        {

            // Store the raw content of the ZIP
            var io = new IOBuffer(archive);
            var directoryIndex = new ZipClass.CentralDirectory(io);

            // We store pointers filename -> Entry
            this.entries = directoryIndex.entries;
            this.files   = directoryIndex.files;
        }
        ZipClass.Archive = ZipClass.prototype.Archive;

        ZipClass.prototype.CentralDirectory = function (io)
        {
            ...
            while (i--) {
                var entry = new ZipClass.CentralDirectoryEntry(io);
        ...
        ZipClass.CentralDirectory = ZipClass.prototype.CentralDirectory;

        ZipClass.prototype.CentralDirectoryEntry = function (io)
        {

            var rawHeader = io.read(46);
            var header = rawHeader.unpack('VCCvvvvvVVVvvvvvVV');
            ...
            entry = new ZipClass.Entry(io, localHeaderOffset);
            this.content = entry.content;
        }
        ZipClass.CentralDirectoryEntry = ZipClass.prototype.CentralDirectoryEntry;

        ZipClass.prototype.Entry = function (io, startOffset)
        {
        ...
        ZipClass.Entry = ZipClass.prototype.Entry;
    ...
    if (typeof define === 'function') {
        define( 'zipclass', [], function () { return ZipClass; } );
    }
    else {
        exports.ZipClass = ZipClass   ;
    }
